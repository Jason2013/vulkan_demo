...
private:
    ...
    void createIndexBuffer(void* indexData, size_t size, VkBuffer& indexBuffer, VkDeviceMemory& indexBufferMemory) {
        VkDeviceSize bufferSize = size;
    ...
    void createMyBuffer(MyBuffer& buffer)
    {
        createVertexBuffer(buffer.vertices.data(), sizeof(buffer.vertices[0]) * buffer.vertices.size(), buffer.vertexBuffer, buffer.vertexBufferMemory);
        createIndexBuffer(buffer.indices.data(), sizeof(buffer.indices[0]) * buffer.indices.size(), buffer.indexBuffer, buffer.indexBufferMemory);
    ...
    void updateUniformBuffer(uint32_t currentImage) {
        ...
        ubo.model = b * a;
        ubo.view = glm::lookAt(glm::vec3(0.0f, 0.0f, 80.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
